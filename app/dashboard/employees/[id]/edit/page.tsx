...
export default function EmployeeEditPage({ params }: EmployeeEditProps) {
    ...
    const loadEmployeeData = async () => {
      try {
        ...
        setFormData({
          ...
          contract_type: employee.contract_type || "NOMINA",
          contract_number: employee.contract_number || "",
          hire_date: employee.hire_date || "",
          salary_type: employee.salary_type || "FIJO",
          ...
          is_active: employee.status === "ACTIVO",
        })
      } catch (error) {
    ...
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      ...
      <Card className="max-w-4xl">
        <CardHeader>
          ...
          <CardDescription>Actualiza la información del empleado</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <Button asChild type="button" variant="outline">
                <Link href={`/dashboard/employees/${params.id}`}>Cancelar</Link>
              </Button>
            </div>
          </form>
        </CardContent>
